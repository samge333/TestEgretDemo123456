...
function FightQTEController:ctor()
    ...
    local function init_fight_qte_controller_terminal()
        ...
        local fight_qte_controller_add_role_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_add_role")
        ...
        local fight_qte_controller_role_by_active_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_role_by_active")
        ...
        local fight_qte_controller_init_role_qte_state_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_init_role_qte_state")
        ...
        local fight_qte_controller_qte_to_next_attack_role_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_qte_to_next_attack_role")
        ...
        local fight_qte_controller_qte_to_next_attack_role_lock_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_qte_to_next_attack_role_lock")
        ...
        local fight_qte_controller_qte_to_next_attack_role_unlock_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_qte_to_next_attack_role_unlock")
        ...
        local fight_qte_controller_qte_hide_progress_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_qte_hide_progress")
        ...
        local fight_qte_controller_enter_auto_fight_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_enter_auto_fight")
        ...
        local fight_qte_controller_enter_next_auto_fight_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_enter_next_auto_fight")
        ...
        local fight_qte_controller_reset_fight_head_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_reset_fight_head")
        ...
        local fight_qte_controller_get_qte_state_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_get_qte_state")
        ...
        local fight_qte_controller_shake_ui_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_shake_ui")
        ...
        local fight_qte_controller_progress_continue_play_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_progress_continue_play")
        ...
        local fight_qte_controller_change_mission_state_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_change_mission_state")
        ...
        local fight_qte_controller_change_visible_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_change_visible")
        ...
        local fight_qte_controller_update_role_cell_state_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_update_role_cell_state")
        ...
        local fight_qte_controller_update_draw_power_skill_total_damage_terminal = {
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                print("连击 _invoke, fight_qte_controller_update_draw_power_skill_total_damage")
...
function FightQTEController:qteToAutoNextAttackRole(params)
    ...
    print("找到下一个要动手的fightRole，准备进行攻击")

...
local platform_manager_open_sdk_interface_terminal = {
    ...
    _invoke = function(terminal, instance, params)
        app.load("client.operation.platformSDKInterface.platform_SDK_login_move")
        fwin:open(platformSDKLoginMove:new(), fwin._ui)
        return true
    end,
    _terminal = nil,
    _terminals = nil
...
local platform_manager_login_terminal = {
    ...
    _invoke = function(terminal, instance, params)
        ...
        _ED.move_lofin_type = params.messageText
        return true
    end,
    _terminal = nil,
    _terminals = nil
...
local platform_manager_login_success_terminal = {
    ...
    _invoke = function(terminal, instance, params)
        ...
        cc.UserDefault:getInstance():setStringForKey("moveLofinType", "".._ED.move_lofin_type)
...
local platform_request_for_payment_terminal = {
    ...
    _invoke = function(terminal, instance, params)
		...
		if cc.Application:getInstance():getTargetPlatform() == cc.PLATFORM_OS_IPHONE or cc.Application:getInstance():getTargetPlatform() == cc.PLATFORM_OS_IPAD then
			...
			"|".._ED.user_info.user_id.."|".._ED.all_servers[_ED.selected_server].server_name.."|"..(tonumber(m_reqcharge_info.rechargeIndex) - 1)..

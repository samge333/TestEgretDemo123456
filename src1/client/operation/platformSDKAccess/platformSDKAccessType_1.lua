...
local platform_manager_login_success_terminal = {
    ...
    _invoke = function(terminal, instance, params)
		...
		local paramsz = zstring.split(app.configJson.url, ":")
...
local platform_manager_login_lose_terminal = {
    ...
    _invoke = function(terminal, instance, params)
		...
		fwin:close(fwin:find("ConnectingViewClass"))
		if app.configJson.OperatorName ~= "88box" 
		and app.configJson.OperatorName ~= "pocket" then
...
local platform_request_for_payment_terminal = {
    ...
    _invoke = function(terminal, instance, params)
		...
		local m_informUrl = nil
		if app.configJson.OperatorName == "uc" or app.configJson.OperatorName == "wdj" then
			m_informUrl = m_informUrlData[1].."pay/notifyUC.do"
		else
			m_informUrl = m_informUrlData[1].."pay/notifyQihoo.do"
		end
		local game_money = dms.int(dms["top_up_goods"], tonumber(m_reqcharge_info.rechargeIndex), top_up_goods.game_money)
		local giveGold = nil
		local remarkInfo = "pay"
		if app.configJson.OperatorName == "efun" then
			if dms.int(dms["top_up_goods"], tonumber(m_reqcharge_info.rechargeIndex), top_up_goods.goods_type) == 1 then
				if dms.int(dms["top_up_goods"], tonumber(m_reqcharge_info.rechargeIndex), top_up_goods.picture_index) == 3020 then
					remarkInfo = "monthlycard"
				else
					remarkInfo = "supercard"
				end
			end
		end
		...
		if (app.configJson.OperatorName == "88box" and app.configJson.PayOperatorName == "app") 
		or (app.configJson.OperatorName == "pocket" and app.configJson.PayOperatorName == "app") then
			local indexs = tonumber(m_reqcharge_info.rechargeIndex)-1
			handlePlatformRequest(0, PLATFORMRECHARGE, _ED.recharge_result.recharge_id.."|"..indexs.."|"..money..
			"|"..game_money.."|"..giveGold)
		else
			if app.configJson.OperatorName == "uc" or app.configJson.OperatorName == "wdj" then
				handlePlatformRequest(0, PLATFORMRECHARGE, _ED.recharge_result.recharge_id.."|".._ED.user_info.user_id.."|".._ED.user_info.user_name.."|".._ED.user_info.user_grade.."|"..money.."|"..goodsName.."|"..goodsId.."|".._ED.default_user.."|"..m_informUrl..
			"|"..game_money.."|"..giveGold.."|".._ED.all_servers[_ED.selected_server].server_name.."|"..m_reqcharge_info.rechargeIndex.."|"..remarkInfo.."|".._ED.recharge_result.ucMd5sing)
			else
				handlePlatformRequest(0, PLATFORMRECHARGE, _ED.recharge_result.recharge_id.."|".._ED.user_info.user_id.."|".._ED.user_info.user_name.."|".._ED.user_info.user_grade.."|"..money.."|"..goodsName.."|"..goodsId.."|".._ED.default_user.."|"..m_informUrl..
			"|"..game_money.."|"..giveGold.."|".._ED.all_servers[_ED.selected_server].server_name.."|"..m_reqcharge_info.rechargeIndex.."|"..remarkInfo)
			end
...
local platform_the_roles_tracking_terminal = {
    ...
    _invoke = function(terminal, instance, params)
		if __lua_project_id == __lua_project_red_alert then
			handlePlatformRequest(0, CC_GAME_DAYA_TRACKING, _ED.user_info.user_id.."|".._ED.user_info.user_name.."|".._ED.user_info.user_grade.."|".._ED.selected_server.."|".._ED.all_servers[_ED.selected_server].server_name.."|".._ED.user_info.user_gold.."|".._ED.default_user.."|".._ED.user_info.create_time)
		else
			handlePlatformRequest(0, CC_GAME_DAYA_TRACKING, _ED.user_info.user_id.."|".._ED.user_info.user_name.."|".._ED.user_info.user_grade.."|".._ED.selected_server.."|".._ED.all_servers[_ED.selected_server].server_name.."|".._ED.user_info.user_gold.."|".._ED.default_user.."|".._ED.system_current_sweep_time)
		end
		return true
    end,
    _terminal = nil,
...
local platform_the_role_upgrade_terminal = {
    ...
    _state = 0,
    _invoke = function(terminal, instance, params)
		handlePlatformRequest(0, CC_ROLE_UPGRADE, _ED.user_info.user_name.."|".._ED.user_info.user_grade.."|".._ED.user_info.create_time.."|".._ED.user_info.user_id.."|".._ED.user_info.user_name.."|".._ED.user_info.user_grade.."|".._ED.selected_server.."|".._ED.all_servers[_ED.selected_server].server_name.."|".._ED.user_info.user_gold.."|".._ED.default_user.."|".._ED.user_info.create_time)
        return true
    end,
    _terminal = nil,
    _terminals = nil

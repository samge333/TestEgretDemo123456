...
local platform_request_for_payment_terminal = {
    ...
    _invoke = function(terminal, instance, params)
		...
		handlePlatformRequest(0, PLATFORMRECHARGE, _ED.recharge_result.recharge_id.."|".._ED.recharge_result.recharge_qudao_id.."|".._ED.recharge_result.recharge_qudao_accesskey.."|"..goods_name.."|"..money..
		"|"..game_money.."|"..giveGold)
        return true
    end,
    _terminal = nil,

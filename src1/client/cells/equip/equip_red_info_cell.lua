...
EquipRedInfoCell = class("EquipRedInfoCellClass", Window)
   
function EquipRedInfoCell:ctor()
    self.super:ctor()
	self.hero = nil
	-- 定义封装类中的变量
...
function EquipRedInfoCell:onEnterTransitionFinish()
    local csbEquipInfoStrengthenListCell = csb.createNode("packs/EquipStorage/equipment_information_list_8.csb")
...
function EquipRedInfoCell:onUpdateDraw() --缘分
...
function EquipRedInfoCell:onExit()

end

function EquipRedInfoCell:init(equipInfo)
	self.equipInfo = equipInfo
end

function EquipRedInfoCell:createCell()
	local cell = EquipRedInfoCell:new()

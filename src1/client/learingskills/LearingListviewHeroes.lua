...
LearingListviewHeroes = class("LearingListviewHeroesClass", Window)
app.load("client.learingskills.cells.learing_list_cell")
function LearingListviewHeroes:ctor()
    self.super:ctor()
    self.roots = {}
    self.list_view = nil
    ...
    local function init_learing_skills_list_heroes_terminal()
        local learing_skills_list_heroes_shot_terminal = {
            _name = "learing_skills_list_heroes_shot",
        ...
        local learing_skills_list_heroes_update_terminal = {
            _name = "learing_skills_list_heroes_update",
            _init = function (terminal)
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                state_machine.excute("learing_skills_list_heroes_shot",0,"")
        ...
        state_machine.add(learing_skills_list_heroes_shot_terminal)
        state_machine.add(learing_skills_list_heroes_update_terminal)
        state_machine.init()
    end
    
    -- call func init hom state machine.
    init_learing_skills_list_heroes_terminal()
end
function LearingListviewHeroes:getSort()
    local result = {}
    ...
    for i=1,#dms["skill_equipment_mould"] do
        ...
        if camp_preference == 4 and can_learn_skilltype == skill_type then
...
function LearingListviewHeroes:onInit()
...
function LearingListviewHeroes:onUpdate()
...
function LearingListviewHeroes:onUpdateDraw()
...
function LearingListviewHeroes:init()
    self:onInit()
end
function LearingListviewHeroes:onEnterTransitionFinish()

end

function LearingListviewHeroes:onExit()
    state_machine.remove("learing_skills_list_heroes_shot") 
    state_machine.remove("learing_skills_list_heroes_update")
end
...
LearingListviewEquipHeroes = class("LearingListviewEquipHeroesClass", Window)

function LearingListviewEquipHeroes:ctor()
    self.super:ctor()
    self.roots = {}
    self.list_view = nil
    ...
    local function init_learing_skills_list_equip_heroes_terminal()
        local learing_skills_list_equip_heroes_shot_terminal = {
            _name = "learing_skills_list_equip_heroes_shot",
        ...
        local learing_skills_list_equip_heroes_update_terminal = {
            _name = "learing_skills_list_equip_heroes_update",
            _init = function (terminal)
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                state_machine.excute("learing_skills_list_equip_heroes_shot",0,"")
        ...
        state_machine.add(learing_skills_list_equip_heroes_shot_terminal)
        state_machine.add(learing_skills_list_equip_heroes_update_terminal)
        state_machine.init()
    end
    
    -- call func init hom state machine.
    init_learing_skills_list_equip_heroes_terminal()
end

function LearingListviewEquipHeroes:getSort()
    local result = {}
    local hero_main = {}
    local hero_other = {}
...
function LearingListviewEquipHeroes:onInit()
...
function LearingListviewEquipHeroes:onUpdate()
...
function LearingListviewEquipHeroes:onUpdateDraw()
...
function LearingListviewEquipHeroes:init()
    self:onInit()
end
function LearingListviewEquipHeroes:onEnterTransitionFinish()

end

function LearingListviewEquipHeroes:onExit()
    state_machine.remove("learing_skills_list_equip_heroes_shot") 
    state_machine.remove("learing_skills_list_equip_heroes_update")
end
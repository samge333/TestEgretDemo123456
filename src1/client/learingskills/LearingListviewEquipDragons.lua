...
LearingListviewEquipDragons = class("LearingListviewEquipDragonsClass", Window)

function LearingListviewEquipDragons:ctor()
    self.super:ctor()
    self.roots = {}
    self.list_view = nil
    ...
    local function init_learing_skills_list_equip_dragons_terminal()
        local learing_skills_list_equip_dragons_shot_terminal = {
            _name = "learing_skills_list_equip_dragons_shot",
        ...
        local learing_skills_list_equip_dragons_update_terminal = {
            _name = "learing_skills_list_equip_dragons_update",
            _init = function (terminal)
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                state_machine.excute("learing_skills_list_equip_dragons_shot",0,"")
        ...
        state_machine.add(learing_skills_list_equip_dragons_shot_terminal)
        state_machine.add(learing_skills_list_equip_dragons_update_terminal)
        state_machine.init()
    end
    
    -- call func init hom state machine.
    init_learing_skills_list_equip_dragons_terminal()
end

function LearingListviewEquipDragons:getSort()
    local result = {}
    local hero_main = {}
    local hero_other = {}
...
function LearingListviewEquipDragons:onInit()
...
function LearingListviewEquipDragons:onUpdate()
...
function LearingListviewEquipDragons:onUpdateDraw()
...
function LearingListviewEquipDragons:init()
    self:onInit()
end
function LearingListviewEquipDragons:onEnterTransitionFinish()

end

function LearingListviewEquipDragons:onExit()
    state_machine.remove("learing_skills_list_equip_dragons_shot") 
    state_machine.remove("learing_skills_list_equip_dragons_update")
end
...
LearingListviewEquipLotus = class("LearingListviewEquipLotusClass", Window)

function LearingListviewEquipLotus:ctor()
    self.super:ctor()
    self.roots = {}
    self.list_view = nil
    ...
    local function init_learing_skills_list_equip_lotus_terminal()
        local learing_skills_list_equip_lotus_shot_terminal = {
            _name = "learing_skills_list_equip_lotus_shot",
        ...
        local learing_skills_list_equip_lotus_update_terminal = {
            _name = "learing_skills_list_equip_lotus_update",
            _init = function (terminal)
            ...
            _state = 0,
            _invoke = function(terminal, instance, params)
                state_machine.excute("learing_skills_list_equip_lotus_shot",0,"")
        ...
        state_machine.add(learing_skills_list_equip_lotus_shot_terminal)
        state_machine.add(learing_skills_list_equip_lotus_update_terminal)
        state_machine.init()
    end
    
    -- call func init hom state machine.
    init_learing_skills_list_equip_lotus_terminal()
end

function LearingListviewEquipLotus:getSort()
    local result = {}
    local hero_main = {}
    local hero_other = {}
...
function LearingListviewEquipLotus:onInit()
...
function LearingListviewEquipLotus:onUpdate()
...
function LearingListviewEquipLotus:onUpdateDraw()
...
function LearingListviewEquipLotus:init()
    self:onInit()
end
function LearingListviewEquipLotus:onEnterTransitionFinish()

end

function LearingListviewEquipLotus:onExit()
    state_machine.remove("learing_skills_list_equip_lotus_shot") 
    state_machine.remove("learing_skills_list_equip_lotus_update")
end
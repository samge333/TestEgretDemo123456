...
class SkillInfluence {
	...
	public init(row) {
		this.id = row[0];					
		this.skillMould = row[1];				
		this.influenceDescribe = row[2];			
		this.skillCategory = row[3];			
		this.skillParam = row[4];				
		this.skillEffectMinValue = row[5];			
		this.skillEffectMaxValue = row[6]; 
		this.formulaInfo = row[7];   		
		this.isRate = row[8];			
		...
		this.beforeAction = row[15];      
		this.forepartLightingEffectId = row[16];		
		this.forepartLightingSoundEffectId = row[17];				
		this.afterAction = row[18];			
		this.posteriorLightingEffectId = row[19];
		this.attackSection = row[20];	
		this.posteriorLightingSoundEffectId = row[21];	
		this.lightingEffectDrawMethod = row[22];		
		this.lightingEffectCount = row[23];			
		this.armyBearAction = row[24];			
		this.bearLightingEffectId = row[25];			
		this.bearSoundEffectId = row[26];     
		this.isVibrate = row[27];		
		this.pathAcrtoon = row[28];				
		this.rearEnd = row[29];			
		this.beforeAttackFrame = row[30];
		this.hitDown = row[31];	
		this.levelInitValue = row[32];	
		this.levelGrowValue = row[33];		
		this.levelPercentGrowValue = row[34];	
		this.nextSkillInfluence = row[35];
	}
}